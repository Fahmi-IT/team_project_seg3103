...
javac -cp "lib/cucumber_lib/*" -d build/classes src/main/java/main/*.java
if %errorlevel% neq 0 (
...
javac -cp "lib/cucumber_lib/*;build/classes" -d build/classes src/test/java/runners/*.java
if %errorlevel% neq 0 (
...
javac -cp "lib/cucumber_lib/*;build/classes" -d build/classes src/test/java/steps/*.java
if %errorlevel% neq 0 (
